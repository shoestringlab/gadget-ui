...
<html>
	<head>
		<title>gadget-ui CollapsiblePane Test</title>
		 <script src='../bower_components/lazyloader/dist/lazy.1.0.0.min.js'></script>
		 <script>
		 	lazy.load(['collapsiblepane.js < ../dist/gadget-ui.js', "/bower_components/velocity/velocity.js", '../dist/gadget-ui.css', "/bower_components/open-iconic/font/css/open-iconic.css" ], function(){
