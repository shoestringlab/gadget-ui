...
new gadgetui.input.SelectInput(document.querySelector("select[name='role']"), {
	emitEvents: true,
	model: gadgetui.model,
});

new gadgetui.input.SelectInput(document.querySelector("select[name='role2']"), {
	emitEvents: false,
	model: gadgetui.model,
});

new gadgetui.input.SelectInput(document.querySelector("select[name='role3']"), {
	emitEvents: false,
	model: gadgetui.model,
